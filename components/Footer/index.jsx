...
function Footer() {
  return (
    <div className="md:pl-[289px] relative bottom-[5.75rem] md:bottom-14 left-0 w-full md:bg-vert-light-gradient bg-white dark:bg-gray-800 md:!bg-transparent dark:md:bg-vert-dark-gradient">
