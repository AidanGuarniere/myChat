...
function PromptForm({ userText, setUserText, handleSubmit, loading }) {
  ...
  return (
    <div className="stretch flex flex-col flex-grow w-full">
      <form
        className="flex flex-row gap-3 w-full mx-auto max-w-[96%] md:max-w-md lg:max-w-2xl xl:max-w-4xl mt-2 mb-1 sm:pl-3.5 py-2 sm:py-3.5 pr-0 relative border border-black/10 
